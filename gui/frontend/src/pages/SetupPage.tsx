...
const DOCKER_RUN_CMD = `docker rm -f fiberfoam 2>/dev/null; docker run -d --name fiberfoam -p 3000:8000 -v fiberfoam-data:/data -v /:/host ${DOCKER_IMAGE}`
const DOCKER_RUN_CMD_WIN = `docker rm -f fiberfoam 2>$null; docker run -d --name fiberfoam -p 3000:8000 -v fiberfoam-data:/data -v C:\\:/host ${DOCKER_IMAGE}`
